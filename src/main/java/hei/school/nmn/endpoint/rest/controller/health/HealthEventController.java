package hei.school.nmn.endpoint.rest.controller.health;

import static hei.school.nmn.endpoint.rest.controller.health.PingController.KO;
import static hei.school.nmn.endpoint.rest.controller.health.PingController.OK;
import static java.util.UUID.randomUUID;

import hei.school.nmn.PojaGenerated;
import hei.school.nmn.endpoint.event.EventProducer;
import hei.school.nmn.endpoint.event.model.DurablyFallibleUuidCreated1;
import hei.school.nmn.endpoint.event.model.DurablyFallibleUuidCreated2;
import hei.school.nmn.endpoint.event.model.UuidCreated;
import hei.school.nmn.repository.DummyUuidRepository;
import hei.school.nmn.repository.model.DummyUuid;
