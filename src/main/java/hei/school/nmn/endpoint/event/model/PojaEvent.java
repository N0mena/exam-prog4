package hei.school.nmn.endpoint.event.model;

import static hei.school.nmn.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import hei.school.nmn.PojaGenerated;
import hei.school.nmn.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "hei.school.nmn.event1";
    return "hei.school.nmn.event2";
  }
}
