package hei.school.nmn.endpoint.event.consumer;

import hei.school.nmn.PojaGenerated;
import hei.school.nmn.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("hei.school.nmn.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "hei.school.nmn.service.event."
