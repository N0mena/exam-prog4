package hei.school.nmn.handler;

import static hei.school.nmn.concurrency.ThreadRenamer.renameWorkerThread;
...
import hei.school.nmn.PojaApplication;
import hei.school.nmn.PojaGenerated;
import hei.school.nmn.endpoint.EndpointConf;
import hei.school.nmn.endpoint.event.EventConf;
import hei.school.nmn.endpoint.event.consumer.EventConsumer;
import hei.school.nmn.endpoint.event.consumer.model.ConsumableEvent;
import hei.school.nmn.endpoint.event.consumer.model.ConsumableEventTyper;
